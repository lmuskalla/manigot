...
// mg-jdi, x/del remove job, t tig, l tail, g git panel, P push to origin, c
// commit all, esc/q, ctrl+r). Developer uses "d" (case matters: distinct from
// the Shift'd "D" mark-done binding). This table is the single source of truth for
